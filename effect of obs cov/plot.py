...
rate.BatchRate2(dist_dict_all, obs_gap).plot(plot_folder, tag='obs_cov_all', ylim=(0.5, 12.0), fsize=25)
l2.BatchL22([error_dict_all_1, error_dict_all_2], obs_gap)\
   .plot(plot_folder, tag='obs_cov_all', ylim=(0.0, 4.0), fsize=25, labels=['unbiased', 'biased'], linestyles=['solid', 'dashed'])
# trace.BatchTr2([error_dict_all_1, error_dict_all_2], obs_gap)\
#    .plot(plot_folder, tag='obs_cov_all', ylim=(0.0, 20.0), fsize=25, labels=[r'unbiased', 'biased'], linestyles=['solid', 'dashed'])
# dvl2.BatchDvL22(dist_dict_all, error_dict_all_2, obs_gap).plot(plot_folder, tag='obs_cov_all', ylim=(0.2, 4.0), xlim=(1.5, 11.5), fsize=25)