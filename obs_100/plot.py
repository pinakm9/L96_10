...
# collect files
dist_dict_all = {obs_gap:[] for obs_gap in [0.05]}
...
# collect files
error_dict_all_1 = {obs_gap:[] for obs_gap in [0.05]}
error_dict_all_2 = {obs_gap:[] for obs_gap in [0.05]}
...
# dvs.BatchDvs(dist_dict_all, error_dict_all_2).plot(plot_folder, tag='obs_gap_all', obs_cov=obs_cov, ylim=(0.2, 2.0), xlim=(1.5, 11.5), fsize=40, linewidth=5.)
# dvrmse.BatchDvL2(dist_dict_all, error_dict_all_2).plot(plot_folder, tag='obs_gap_all', obs_cov=obs_cov, ylim=(0.2, 4.0), xlim=(1.5, 11.5), fsize=40, linewidth=5.)